  ...
  const upcomingMaintenance = [
    {
      ...
      due: "Soon",
      priority: "high",
      description: "High impact events logged recently"
    },
    {
          ...
          <CardContent className="p-4">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <p className="text-[#1F2F57] dark:text-slate-200 text-sm mb-1">Service Coming Up</p>
                <p className="text-[#9394a5] dark:text-slate-400 text-xs">Due in 5,000 km or within 3 months</p>
              </div>
            </div>
          </CardContent>
        </Card>
                ...
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3 flex-1">
                    ...
                    <div className="flex-1">
                      ...
                      {item.description && (
                        <p className="text-[#9394a5] dark:text-slate-400 text-xs mb-2">{item.description}</p>
                      )}
