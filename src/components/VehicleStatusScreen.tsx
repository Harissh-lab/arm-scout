  ...
  return (
    <div className="min-h-screen bg-[#FDFAF9] dark:bg-slate-950 pb-20 sm:pb-24">
      ...
      <div className="px-4 mt-4">
        <Card className="bg-blue-50 dark:bg-slate-900/90 border-blue-200 dark:border-slate-700/50">
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-[#0070E1]/20 flex items-center justify-center">
                  <Activity className="w-5 h-5 text-[#001E50] dark:text-[#0070E1]" />
                </div>
                <div>
                  <p className="text-[#1F2F57] dark:text-slate-200 text-sm mb-1">Road Condition Impact</p>
                  <p className="text-[#484B6A] dark:text-slate-400 text-xs">Based on detected road hazards</p>
                </div>
              </div>
              <div className="text-right">
                <p className="text-green-600 dark:text-green-400">Low Impact</p>
